...
class FeatureDetection:
    ...
    def elution_peak_detection(self):
        ...
        self_deconvol_df = pd.DataFrame({'label': labels, 'intensity': intensities, 'size': size, 'length': length, 'convexhull': convexhull, 'smoothed_intensities': smoothed_intensities, 'mz': mz, 'RT': RT})
