...
class FeatureMapProcessor(FeatureDetection):
    ...
    def process(self):
        ...
        filtered_features = [feature for feature in filtered_features_ 
                             if feature_classifier(feature.getMetaValue("masstrace_centroid_mz"), feature.getCharge()) == 0]
        filtered_features_1 = [feature for feature in filtered_features_
                                if feature_classifier(feature.getMetaValue("masstrace_centroid_mz"), feature.getCharge()) == 1]
        filtered_features_2 = [feature for feature in filtered_features_
                                if feature_classifier(feature.getMetaValue("masstrace_centroid_mz"), feature.getCharge()) == 2]
        filtered_features_3 = [feature for feature in filtered_features_
                                if feature_classifier(feature.getMetaValue("masstrace_centroid_mz"), feature.getCharge()) == 3]
