...
def flow_base(file,model_path,pars, EPM, EPM_dense_output_model, ADM, blank=None,ms2=None):
    """
    ...
    df_feature_for_model_input = df_feature_for_model_input[EPM_dense_output_model, ADM,df_feature_for_model_input['reconstruction_error'] <= pars.FeatureFilter_Anomaly_detection_threshold]
