...
class dereplication():
    ...
    def dereplication(self):
        ...
        for idx,row in self.Deephalo_output.iterrows():
            ...
            dereplications = {'compound_names':[],'intensity_score':[],'error':[]}
            ...
            if self.data_.empty:
                ...
                self.Deephalo_output.loc[idx,'compound_names'] = self.data_.loc[self.data_['intensity_score'].idxmax(),'compound_namess']
