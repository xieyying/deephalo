...
class Dataset:
    ...
    def create_dataset(self, type):
        ...
        df_data_pos_3['M+H'] = self.df_data['mz_0']-1.007825*2
        
        df_data_pos_2 = self.df_data[self.df_data['formula_x'].str.contains('\+2')]
        df_data_pos_2['M+H'] = self.df_data['mz_0']-1.007825
