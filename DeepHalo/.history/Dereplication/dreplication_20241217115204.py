...
class dereplication():
    ...
    def dereplication(self):
        ...
        for idx,row in self.Deephalo_output.iterrows():
            ...
            self.data_ = self.data[(abs(self.data['mz'] - row['mz']) <= row['mz'] * 1e-5) & (self.data['formula_x'].str.contains('Br|Cl'))]
            ...
            if self.data_.empty:
                ...
                self.Deephalo_output.loc[idx,'dereplications'] = dereplications
            else:
                #计算intensity_score
...
if __name__ == '__main__':
    ...
    database = r'K:\open-database\NPAtlas\V2024_03\NPAtlas_download_2024_03.csv'
