...
def anormal_isotope_pattern_detection(df_feature):
    ...
    output = os.path.join(work_folder, 'anormal_detect', 'hyperparameter_opt_results', '256_64_16.h5')
...
def plot_quantile_curve(df, col='reconstruction_error'):
    ...
    results.to_csv(r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\anormal_detect\hyperparameter_opt_results\model_256_64_16.csv', index=False)
