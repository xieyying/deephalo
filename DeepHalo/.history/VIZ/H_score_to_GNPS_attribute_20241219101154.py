...
def add_deephalo_results_to_graphml(gnps_folder, deephalo_result):
    ...
    for node, data in graph.nodes(data=True):
        ...
        if not halo_data_.empty:
            ...
            Class_pre = int(default_class_pred)
...
if __name__ == '__main__':
    gnps_folder = r'D:\workissues\manuscript\halo_mining\mining\result\53_strep_1_micromono_blank_GNPS'
    deephalo_result = r'D:\workissues\manuscript\halo_mining\mining\result\53_strep_1_micromono_blank'
