...
def plot_pca_2D(groups_data, group_labels):
    ...
    chart.save('pca_2d_plot.html')
    webbrowser.open('pca_2d_plot.html')

def plot_pca_3D(groups_data, group_labels):
    """
    Perform PCA on the provided data and plot the results using Plotly.
    ...
    fig = px.scatter_3d(pca_df, x='PCA1', y='PCA2', z='PCA3', color='Group', title='PCA Plot Showing Chemical Relationships')
    fig.show()
    fig.write_png('pca_3d_plot.png')

if __name__ == '__main__':
    validation_data = r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\datasets\training_validation_dataset\train_and_val\validation_data_noise_added\inty_0.07_0.006_mz_0.0018\validation_data.csv'
