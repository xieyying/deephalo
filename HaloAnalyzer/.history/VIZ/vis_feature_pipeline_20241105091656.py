...
if __name__ == '__main__':
    ...
    project_path = r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\WJH_all\halo'    pv = PipelineVis(project_path)
    pv.main()
