...
def add_deephalo_results_to_graphml(gnps_folder, deephalo_result, default_h_score_mean=0.0):
    ...
    for node, data in graph.nodes(data=True):
        ...
        if not halo_data_.empty:
            ...
            # compound_names = str(halo_data_.loc[halo_data_['error_ppm'].idxmin(), 'compound_names'])
            ...
            # Smiles = str(halo_data_.loc[halo_data_['error_ppm'].idxmin(), 'Smiles'])
        ...
        graph.nodes[node]['compound_name'] = compound_names
