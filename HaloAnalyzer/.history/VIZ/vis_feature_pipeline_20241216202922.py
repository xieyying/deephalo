...
if __name__ == '__main__':
    ...
    project_path = r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\halo\inty_more_than_1e6'
    pv = PipelineVis(project_path)
    pv.main()
    
    # files = os.listdir(project_path)
    # files = [file for file in files if file.endswith('feature.csv')]
    # output = project_path + '\\inty_more_than_1e6'
