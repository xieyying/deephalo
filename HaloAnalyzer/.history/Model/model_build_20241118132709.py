...
def model(input_shape,  output_shape):
    ...
    # y = layers.Dense(8, activation="relu")(input2)

    share = layers.concatenate([input1, input2])  
    share = layers.Dense(32, activation="relu")(share) # layer1
    # share = layers.Dropout(.3)(share)    #layer1
    share = layers.Dense(64, activation="relu")(share) # layer2
    # share = layers.Dropout(.3)(share)    #layer2
    # share = layers.Dense(128, activation="relu")(share) # layer3
    # share = layers.Dropout(.3)(share)    #layer3
    # share = layers.Dense(512, activation="relu")(share) # layer4
    # share = layers.Dropout(.3)(share)    #layer4
    # share = layers.Dense(512, activation="relu")(share) # layer5
