...
if __name__ == '__main__':
    ...
    Deephalo_output_result = r'D:\workissues\manuscript\halo_mining\mining\result\result_blank\halo_'
    
    files = os.listdir(Deephalo_output_result)
    Deephalo_outputs = [file for file in files if file.endswith('feature.csv')]
    dereplication_folder = Deephalo_output_result.replace('halo_', 'dereplication')
