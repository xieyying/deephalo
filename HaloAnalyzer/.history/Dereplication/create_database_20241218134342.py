...
if __name__ == '__main__':
    ...
    database_file = r'D:\workissues\manuscript\halo_mining\mining\dereplication_database\NPAtlas\NPAtlas_download_2024_03.csv'
    test = Dataset(database_file, 'compound_molecular_formula')
    test.work_flow()
