...
class Dataset:
    ...
    def work_flow(self):
        ...
        self.save(r'K:\open-database\NPAtlas\V2024_03\dereplicate_database_base.csv') # TODO: Change the path to the desired location

if __name__ == '__main__':
    # Create a Dataset object and execute the workflow
    test = Dataset(r'D:\workissues\manuscript\halo_mining\mining\dereplication_database\FunGBE\FunGBE_V202412.csv', 'formula')
    test.work_flow()