...
if __name__ == '__main__':
    ...
    Deephalo_output_result = r'D:\workissues\manuscript\halo_mining\mining\result\53_strep_1_micromono_blank\halo\A30'
    
    files = os.listdir(Deephalo_output_result)
    Deephalo_outputs = [file for file in files if file.endswith('feature.csv')]
    dereplication_folder = Deephalo_output_result.replace('A30', 'dereplication')
