...
def load_trained_model():
    ...
    EPM_path = importlib.resources.files('HaloAnalyzer') / 'models/anomaly_detection_model.h5'
...
def process_file(file, args, para,  EPM, EPM_dense_output_model, ADM_model, blank=None,ms2=None):
    """
...
def pipeline_analyze_mzml(args,para):
    ...
    EPM, EPM_dense_output_model, ADM_model = load_trained_model()
