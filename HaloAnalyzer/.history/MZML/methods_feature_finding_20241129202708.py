...
class FeatureDetection:
    ...
    def feature_detection(self):
        ...
        features = self.feature_map.get_df()
        features.to_csv(r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\features.csv', index=False)
    def run(self):
