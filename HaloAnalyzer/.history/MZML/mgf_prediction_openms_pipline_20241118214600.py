...
if __name__ == '__main__':
    ...
    model = os.path.join(folder,'noisy_mz_001_inty_03_new_data','trained_models','pick_halo_ann.h5')
    # model = os.path.join(folder,'200_trails_mz_noise_0.001_inty_0.03_5_peaks','trained_models','pick_halo_ann.h5')
    model = r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\trained_models\pick_halo_ann.h5'
