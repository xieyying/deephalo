        ...
        filtered_features = [
            ...
            if feature.getMetaValue("num_of_masstraces") >= 3 and
               ...
               len(feature.getConvexHulls()[0].getHullPoints()) > self.pars.FeatureMapProcessor_min_scan_number and 
                ((feature.getMetaValue("masstrace_centroid_mz")[0])*(feature.getCharge()) <= 2000) and 
                (0.9964<=(feature.getMetaValue("masstrace_centroid_mz")[1]-feature.getMetaValue("masstrace_centroid_mz")[0]) <= 1.0096) and
                (0.9888<=(feature.getMetaValue("masstrace_centroid_mz")[2]-feature.getMetaValue("masstrace_centroid_mz")[1]) <= 1.0081)
