...
def anormal_isotope_pattern_detection(df_feature):
    ...
    querys_3 = df_feature['mz']*df_feature['charge']/1950
    ...
    anomy_sco = tf.keras.models.load_model(r'C:\Users\xyy\Desktop\python\HaloAnalyzer\HaloAnalyzer\autoencoder_5_peak_intensities_plus_mz0.h5')
