...
def anormal_isotope_pattern_detection_(df_feature):
    querys_2 = df_feature[['p0_int','p1_int','p2_int','p3_int','p4_int']]
    # querys_3 = df_feature['mz']*df_feature['charge']
    # querys_3 = np.log1p(querys_3)
    # min_ = np.log(50)
    # max_ = np.log(2000)
    # querys_3 = (querys_3 - min_) / (max_ - min_)
    # querys_2 = pd.concat([querys_2,querys_3],axis=1)
    querys_2 = querys_2.values.astype('float32')
    anomy_sco = tf.keras.models.load_model(r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms\autoencoder_5_peaks_balance_data_no_mz_0.h5')
...
def anormal_isotope_pattern_detection(df_feature):
    ...
    model_path = r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\200_trails_mz_noise_0.001_inty_0.03_5_peaks\trained_models\pick_halo_ann.h5'
    layer_name = 'dense_3'
    units_1_output_model = load_trained_model(model_path, layer_name)
    autoencoder_input = units_1_output_model.predict(querys_input)
    autoencoder_model = r'C:\Users\xyy\Desktop\python\HaloAnalyzer\HaloAnalyzer\autoencoder_model.h5'
