...
class FeatureDetection:
    ...
    def feature_detection(self):
        ...
        oms.FeatureXMLFile().store( self.feature_map,r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\mass_traces_deconvol.csv', index=False)
