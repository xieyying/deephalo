...
class FeatureDetection:
    ...
    def feature_detection(self):
        ...
        oms.store(self.feature_map, r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\feature_map.featureXML')
        #save the feature map
        features = self.feature_map.get_df(meta_values='all')
        
        print(features.head())
        # features.to_csv(r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\features.csv')
    def run(self):
