...
def mgf_processing_workflow(files,model,feature_list):
    for file in files:
...
def csv_processing_workflow(files,model,feature_list):
...
if __name__ == '__main__':
    ...
    folder = r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules'
    # model = os.path.join(folder,'trained_models','pick_halo_ann.h5')
    # model = os.path.join(folder,'200_trails_mz_noise_0.001_inty_0.03_5_peaks','trained_models','pick_halo_ann.h5')
    model = r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\hyperparameter_optimization\noisy_and_peak_numbers\0.001_inty_0.03_5_peaks\trained_models\pick_halo_ann.h5'
    
    path = r'C:\Users\xyy\Desktop\test\test' 
    path = r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\datasets\training_validation_dataset\train_and_val\validation_data_noise_added\inty_0.07_0.006_mz_0.0018\test2' 
    # path = r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\datasets\training_validation_dataset\train_and_val\validation_data_noise_added\inty_0.05_0.005_mz_0.0015\test'
    
    files = os.listdir(path)
    # mgf_processing_workflow(files,model,feature_list)
    
    csv_processing_workflow(files,model,feature_list)
