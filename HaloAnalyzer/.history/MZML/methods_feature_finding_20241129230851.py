...
class FeatureMapProcessor(FeatureDetection):
    ...
    def process(self):
        ...
        self.deconvol_df.to_csv(r'C:\Users\xyy\Desktop\python\HaloAnalyzer_training\022_six_dataset_openms_noClFe\2M_fake_molecules\result\mass_traces_deconvol_drop.csv', index=False)
