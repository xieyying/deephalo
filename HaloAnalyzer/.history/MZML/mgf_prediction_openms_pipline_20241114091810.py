...
if __name__ == '__main__':
    ...
    path = r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\SIRIUS_comparison\2016AC\standard-noise-profile\standard-noise-profile\5_peaks\merge\csv'
    ...
    for file in files:
        ...
        df_.to_csv(rf'C:\Users\xyy\Desktop\test\tem\{file[:-4]}_features.csv',index=False)
