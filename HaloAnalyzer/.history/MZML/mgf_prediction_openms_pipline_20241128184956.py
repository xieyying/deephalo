...
class mgf_pred():
    ...
    def get_df(self):
        ...
        for spectrum in self.spectra:
            ...
            if formula == 'C5H12NO2Se':
                print(mz)
                print(ints)
                print( mz_list[1]-mz_list[0])
...
if __name__ == '__main__':
    ...
    # path = r'D:\workissues\manuscript\halo_mining\HaloAnalyzer\SIRIUS_comparison\real_data\DCA_SIRIUS_DeepHalo_results\deephalo' 
