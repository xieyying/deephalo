...
def load_trained_model():
    ...
    print("EPM Model loaded successfully.".format(EPM.summary()))
    ...
    print("EPM_dense_output_model Model loaded successfully.".format(EPM_dense_output_model.summary()))
    ...
    print("ADM Model loaded successfully.".format(ADM_model.summary()))
