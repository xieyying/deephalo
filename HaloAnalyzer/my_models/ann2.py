...
class pick_halo_ann2(base):
    ...
    def train(self):
        ...
        train_history=self.clf.fit(train_dataset, epochs=self.parameters['epochs'],callbacks=[tensorboard_callback])
...
if __name__=="__main__":
    train_datset, val_dataset = pick_halo_ann().create_Dataset()
    print(len(train_datset),len(val_dataset))
