...
def get_ROIs(path, delta_mz=0.005, required_points=15, dropped_points=3, progress_callback=None,intensity_threshold=10000):
    '''
    ...
    for mz, i in zip(init_scan.mz, init_scan.i):
        if i >= intensity_threshold: # TODO: change this threshold
    ...
    for scan in tqdm(scans):
        ...
        for n, mz in enumerate(scan.mz):
            if scan.i[n] >= intensity_threshold: #TODO: change this threshold
...
if __name__ == '__main__':
    path = r'C:\Users\xq75\Desktop\test_mzml\Strepomyces_A30_M2_cmx_p16_D2_nr1.mzML'
