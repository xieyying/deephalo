...
def feature_finding(file,para):
    ...
    tem = feature.run()
    df_f,df_scan,df_no_halo = tem.process()

    return df_f,df_scan,tem.feature_map,df_no_halo
...
def flow_base(file,model_path,pars,blank=None,ms2=None):
    ...
    df_f, df_scan, feature_map_,df_no_halo = feature_finding(file, pars)
    ...
    return df_f_result, df_scan_result,df_no_halo
