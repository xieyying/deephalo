...
class FeatureMapProcessor(FeatureDetection):
    ...
    def process(self):
        ...
        # def process_feature_if_valid(feature, min_num_of_masstraces, min_feature_int, min_scan_number):
        #     if feature.getMetaValue("num_of_masstraces") >= min_num_of_masstraces and \
        #     feature.getIntensity() >= min_feature_int and \
        #     len(feature.getConvexHulls()[0].getHullPoints()) > min_scan_number:
        #         return feature
        #     return None

        # min_num_of_masstraces = self.pars.FeatureMapProcessor_min_num_of_masstraces
        # min_feature_int = self.pars.FeatureMapProcessor_min_feature_int
        # min_scan_number = self.pars.FeatureMapProcessor_min_scan_number

        # with concurrent.futures.ThreadPoolExecutor(10) as executor:
        #     futures = [executor.submit(process_feature_if_valid, feature, min_num_of_masstraces, min_feature_int, min_scan_number) for feature in self.feature_map]
