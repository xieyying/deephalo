...
class FeatureMapProcessor(FeatureDetection):
    ...
    def _merge_feature_df(self):
        ...
        #self.df_feature_中其他行的数据，保存为self.df_feature_no_halo
        self.df_feature_no_halo = self.df_feature_[~self.df_feature_['feature_id'].isin(self.feature_id)]
    ...
    def process(self):
        ...
        return self.df_feature, self.df_scan, self.df_feature_no_halo