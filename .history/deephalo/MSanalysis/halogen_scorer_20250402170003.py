...
if __name__ == "__main__":
    ...
    df_f_ = pd.read(os.path.join(work_folder, 'Strepomyces_cmx_11_23_M9_cmx_p9_C9_nr1_feature.csv'))
    df_scan_ = pd.read(os.path.join(work_folder, 'Strepomyces_cmx_11_23_M9_cmx_p9_C9_nr1_scan.csv'))
