...
class HalogenScorer:
    ...
    def score_feature(self, feature_prediction):
        """
    ...
    def calculate_overall_score(self, scan_predictions, feature_prediction):
        ...
        Returns:
            float: Overall score.
        """
        return (self.calculate_prediction_consistency(scan_predictions))/3 + (halo_ratio(scan_predictions))/3 +  (self.score_feature(feature_prediction))/3
