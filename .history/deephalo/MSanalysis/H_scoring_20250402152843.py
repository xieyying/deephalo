...
class HalogenScorer:
    ...
    def calculate_halogen_ratio(self, scan_predictions):
        """
        Calculate the ratio of halogen-positive scans to total scans.
        ...
        halogen_count = sum(1 for pred in scan_predictions if pred in self.halogen_classes)
        # Calculate ratio
        ratio = halogen_count / len(scan_predictions)
        return ratio
    ...
    def calculate_prediction_consistency(self, scan_predictions):
        ...
        Args:
            scan_predictions (list): List of element predictions of scan level isotope patterns for a feature.
    ...
    def score_feature_prediction(self, feature_prediction):
        ...
        Args:
            feature_prediction: The classification value for the feature.
