...
if __name__ == "__main__":
    ...
    scan_predictions = [0, 1, 2, 0, 1, 2,6,7,3,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6]
    feature_prediction = 6
    result = halogen_scorer.process_feature(scan_predictions, feature_prediction)
    print(result)  # Output the results of the analysis