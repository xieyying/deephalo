            ...
            for idx, row in self.Deephalo_output.iterrows():
                ...
                if data_.empty:
                    ...
                    if dereplications['compound_names']:
                        ...
                        self.Deephalo_output.loc[idx, f'compound_names_{dataname}'] = dereplications_df['compound_names'].tolist()
                        self.Deephalo_output.loc[idx, f'Inty_cosine_score_{dataname}'] = dereplications_df['Inty_cosine_score'].tolist()
                        self.Deephalo_output.loc[idx, f'error_ppm_{dataname}'] = dereplications_df['error_ppm'].tolist()
                        self.Deephalo_output.loc[idx, f'Smiles_{dataname}'] = dereplications_df['Smiles'].tolist()
                        self.Deephalo_output.loc[idx, f'adducts_{dataname}'] = dereplications_df['adducts'].tolist()
